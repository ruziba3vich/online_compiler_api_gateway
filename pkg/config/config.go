...
func NewConfig() *Config {
	_ = godotenv.Load()
	return &Config{
		PythonService:       getEnv("PYTHON_SERVICE", "89.117.58.248:702"),
		JavaService:         getEnv("JAVA_SERVICE", "89.117.58.248:701"),
		CppService:          getEnv("CPP_SERVICE", "89.117.58.248:703"),
		JsService:           getEnv("JS_SERVICE", "89.117.58.248:704"),
